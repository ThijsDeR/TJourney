...
Command: npx gltfjsx@6.1.3 walkingLeonard.gltf
*/

import React, { useRef, useEffect } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export default function WalkingLeonard(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/walkingLeonard.gltf')
...
useGLTF.preload('/walkingLeonard.gltf')
