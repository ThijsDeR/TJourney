    ...
    return (
        <>
            ...
            <div style={{ zIndex: 30, width: "100%" }}>
                {screenPart === 0 &&
                    <div className="has-text-white is-size-3 has-text-centered" style={{ position: 'absolute', top: "10vh", zIndex: 30, width: "100%" }}>
                ...
                {screenPart === 2 &&
                    <div className="has-text-white is-size-3 has-text-centered" style={{ position: 'absolute', top: "10vh", zIndex: 30 }}>
            ...
            <div style={{ position: "fixed", top: "0px", bottom: "0px", left: "0px", right: "0px" }}>
                <section className="bg-image" style={{ height: "100%", width: "100%" }}>
                    <RankingBar user={user} level={{ level: 7, xp: 1300, neededXP: 1600 }} />
                </section>
            </div>
