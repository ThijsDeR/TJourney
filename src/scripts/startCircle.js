...
export default class StartCircle extends Circle {
    ...
    getElement() {
        return (
            <mesh position={[this.position.x, this.position.y - this.offset, this.position.z]} rotation={this.rotation.getRotationArray()} material={new THREE.MeshLambertMaterial({color: "red"})}>
